...
// Animations
import { expansionIndicatorRotate } from "../../animate-animation";

// Models
import { CardToggleContentEvent } from "../models/card.model";
...
export class CardComponent {
  /**
   * This exposes the "shared-button" classname to external components to easily access the host component
   */
  @HostBinding("class.shared-card") hostClass = true;
   ...
   */
  @Output() contentToggled: EventEmitter<
    CardToggleContentEvent
  > = new EventEmitter();
